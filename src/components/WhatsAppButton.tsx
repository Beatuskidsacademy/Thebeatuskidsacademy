export function WhatsAppButton() { 
  const phoneNumber = "918095992424"; // Replace with actual WhatsApp number (without + or spaces)
  const message = "Hi! I'm interested in learning more about The Beatus Kids Academy.";
